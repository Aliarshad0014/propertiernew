...
const BlogReadPage = () => {
  const blog = {
    ...
    author: "admin",
    image:
      "https://propertier.com.pk/storage/posts/unleash-the-power-of-propertier-the-best-crm-software-for-real-estate-professionals-2024-05-13-6641f03234c96.png",
  ...
  const latestPosts = ["Post 1", "Post 2", "Post 3", "Post 4"];
              ...
              {categories.map((category, index) => (
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-black bg-opacity-50 flex justify-between items-end p-4">
                    ...
                    <span className="text-white bg-blue-600 rounded-full px-2 py-1 text-sm">
                      {category.count}
                    </span>
                  </div>
                </div>
