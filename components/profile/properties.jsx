      ...
      <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 gap-6">
        ...
        {demoPropertiesData.map((property) => (
          ...
          >
            ...
            <button className="bg-green-500 hover:bg-green-600 transition-all text-white px-2 py-2 rounded absolute top-0 right-0 mt-2 mr-2">
              Make Featured
            </button>
            ...
            <div className="flex justify-end space-x-2">
              <button className="border border-yellow-500 text-black transition-all hover:bg-[#FFCE58] px-4 py-2 rounded">
                Detail
              </button>
              <button className="bg-[#FFCE58] hover:bg-black transition-all text-white px-4 py-2 rounded">
                Edit Price
              </button>
